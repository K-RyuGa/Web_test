...
2.  **表現の自然さと適切さ:** TPOや相手との関係性を踏まえ、ネイティブスピーカーが使うような自然な表現か。話し方は適切か。
...
if st.session_state.logged_in:
    ...
    with st.sidebar:
        ...
        story_prompt = [
            ...
            [ # Chapter 2
                ...
                [ミッション達成の条件]
                プレイヤーが「欲しい商品の場所」や「支払い方法」について日本語で質問・やり取りし、無事に購入できたら達成。
            ...
            [ # Chapter 7
                ...
                [ミッション達成の条件]
                プレイヤーが「屋台」「伝統」「好きな食べ物」などについて会話を楽しみ、日本文化に関する新しい言葉を2つ以上学んだら達成。
    ...
    chapter_descriptions = {
        ...
        "Chapter 2: スーパーでの買い物": "あなたはスーパーマーケットで買い物をしています。探している商品が見つからないか、何か聞きたいことがあります。近くにいる店員に声をかけました。\n\n**今回のミッション：**「欲しい商品の場所」や「支払い方法」を質問し、商品を購入しましょう。",
        ...
        "Chapter 7: お祭りに参加": "あなたは友人に誘われて、近所の神社で開かれている夏祭りに来ている。境内にはたくさんの屋台が並び、浴衣を着た人々で賑わっている。\n\n**今回のミッション：**「屋台」や「伝統」などについて会話を楽しみ、日本文化に関する新しい言葉を2つ以上学びましょう。",
