...
def generate_hint(hint_type, user_input=None):
    ...
    if hint_type == "action":
        hint_instruction = f"""
        あなたは日本語学習の補助AIです。
        以下のゲームの状況と会話履歴を踏まえ、プレイヤーがミッションを達成するために、次に行うべき行動の「方針」や「戦略」を3つ、簡単な日本語で提案してください。
        
        【重要】禁止事項
        プレイヤーが言うべき具体的なセリフや文章を、そのままの形で提示することは固く禁じます。
        
        【ヒントの形式】
        「相手の趣味について質問してみましょう」「もっと丁寧な言葉遣いを試してみてはどうですか？」のように、プレイヤー自身が考えて日本語を組み立てることを促す、行動の方向性を示してください。
...
if st.session_state.logged_in:
    ...
    chapter_descriptions = {
        "Chapter 1: 空港での手続き": "**[場面]** ここは東京国際空港の到着ロビー。長旅の疲れを感じながらも、あなたは「到着」のゲートをくぐり抜けた。目の前には、きびきびと働く空港の係員が立っている.\n**[ミッション]** 係員の案内に従ってパスポートを提示し、荷物の受け取り場所を理解しましょう.",
        "Chapter 2: スーパーでの買い物": "**[場面]** あなたは近所のスーパーで、夕食の材料を選び終え、レジへと向かった。レジには、にこやかな表情の店員が立っている.\n**[ミッション]** 店員の案内に従って会計を済ませ、支払い方法を尋ねられた際に丁寧に対応し、無事に会計を完了させましょう.",
        "Chapter 3: 友人との会話": "**[場面]** あなたは、最近知り合った友人とカフェで会っている。窓の外には公園の緑が広がり、店内には落ち着いた音楽が流れている.\n**[ミッション]** 会話を楽しみ、次に会う約束を取り付けましょう.",
        "Chapter 4: 職場の自己紹介": "**[場面]** 今日からあなたは新しい職場で働くことになった。オフィスに足を踏み入れると、一人の同僚があなたに気づき、笑顔で近づいてきた.\n**[ミッション]** 相手に失礼なく、自分の名前を伝えて自己紹介を完了させましょう.",
        "Chapter 5: 病院での診察": "**[場面]** あなたは体調が悪く、近所の病院に来ている。待合室でしばらく待っていると、看護師に呼ばれ、診察室に入った。中では、白衣を着た医師があなたを待っている.\n**[ミッション]** 自分の症状を正確に説明し、診察を無事に終えましょう.",
        "Chapter 6: 会議での発言": "**[場面]** あなたは職場の会議に参加している。会議が進行する中、上司があなたの意見を求めてきた。周りの同僚たちが、あなたに注目している.\n**[ミッション]** 会議の流れを汲んで、自分の意見をしっかりと発言しましょう.",
        "Chapter 7: お祭りに参加": "**[場面]** あなたは友人に誘われて、近所の神社で開かれている夏祭りに来ている。境内にはたくさんの屋台が並び、浴衣を着た人々で賑わっている.\n**[ミッション]** 友人との会話を楽しみ、お祭りを満喫していることを伝えましょう.",
        "Chapter 8: 市役所での手続き": "**[場面]** あなたは行政手続きのため、市役所の窓口に来ている。番号札を持って待っていると、自分の番号が呼ばれた。あなたは少し緊張しながら、指定された窓口へ向かう.\n**[ミッション]** 指示に従って、必要な手続きを完了させましょう.",
        "Chapter 9: 電車の遅延対応": "**[場面]** あなたは駅のホームで電車を待っているが、予定の時間を過ぎても電車が来る気配がない。電光掲示板には「遅延」の文字が表示されている.\n**[ミッション]** 駅員さんの指示を理解し、次の行動を決めましょう.",
    }
